...
multi_gpu=0
export DATASET_NAME="toml/checkpoint/avatar_512_512_finetuning.toml"   #<数据准备时创建的.toml文件>
export sample_prompts="toml/checkpoint/avatar_512_512_finetuning_sample_prompts.txt"
...
python -m accelerate.commands.launch ${launchArgs[@]} --num_cpu_threads_per_process=8 "sd-scripts/fine_tune.py" \
    ...
    --output_dir="/appdata/finetuning/output/finetuning_avatar/v40"  \
    --output_name="yqAvatar_ft_512_512_v40"  \
