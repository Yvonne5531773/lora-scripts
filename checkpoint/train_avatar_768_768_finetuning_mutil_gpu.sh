...
multi_gpu=1
export DATASET_NAME="toml/checkpoint/avatar_768_768_finetuning.toml"   #<数据准备时创建的.toml文件>
export sample_prompts="toml/checkpoint/avatar_768_768_finetuning_sample_prompts.txt"
...
python -m accelerate.commands.launch ${launchArgs[@]} --num_cpu_threads_per_process=8 "sd-scripts/fine_tune.py" \
    ...
    --output_name="yqAvatar_ft_768_768_v12"  \
