...
config_file="./toml/style/avatar_zjz_768_1024_lora_style.toml"          # config_file | 使用toml文件指定训练参数
sample_prompts="./toml/style/avatar_zjz_768_1024_sample_prompts.txt" # sample_prompts | 采样prompts文件,留空则不启用采样功能
