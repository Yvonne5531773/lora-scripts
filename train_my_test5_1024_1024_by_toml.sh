...
config_file="./toml/user/my_test5/lora_user_1024_1024.toml"          # config_file | 使用toml文件指定训练参数
sample_prompts="./toml/user/my_test5/user_sample_prompts_1024_1024.txt" # sample_prompts | 采样prompts文件,留空则不启用采样功能
