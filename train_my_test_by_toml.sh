...
config_file="./toml/user/my_test/lora_user.toml"          # config_file | 使用toml文件指定训练参数
sample_prompts="./toml/user/my_test/user_sample_prompts.txt" # sample_prompts | 采样prompts文件,留空则不启用采样功能
